...
// >> 다른값을 할당하려고 하면 타입 에러가 발생

//? 리터럴 타입 사용 예시
// : type 키워드(타입 별칭)와 함꼐 사용
//    +) 유니언 타입과 함께 사용하여 다양한 값을 표현함과 동시에 제한 가능
//      >> 변수가 '특정 값'들 중 '하나만 가진 수 있도록 제한'
...
type mixedType01 = 'yes' | 'no' | 1 | 2 | 3;
type mixedType02 = [1, 2] | {id: string; password: string; };
...
greet(p3); // Person과 구조가 일치하기 떄문에 Person 취급
...
userData.email = "cgung7";
// userData.address = { city: 'Geoje' };
