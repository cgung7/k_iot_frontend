...
? 컴포넌트 특징
: 파일명이 반드시 대분자로 시작 (UpperCamelCase 사용)
...
: rfc, rfce 스니펫 사용 시
  ...
  - 외부에서 인식 가능한 컴포넌트로 생상

*/
import bird from '@/assets/images/웃긴앵무새.gif';
...
export function Img() {
  ...
  return (
    ...
    // : 최상위 노드(요소)는 반드시 하나여야한다.
    // - 비워질 수 없음
    <div>
      <p>Img 컴포넌트의 시작</p>
      {/* HTML 코드 내에서 TS 문법 사용 시 {} 사용 */}
      <img src={bird} alt="웃긴 앵무새 짤" width={300} />
    </div>
    // <div>
