...
console.table(findAverage([1, 2, 3, 4])); // 2.5
...
console.log(findMax([1, 2, 3, 5, 4, 10])); // 10
console.log(findMax(array)); // 5
console.log(findAverage(array)); // 3

let number9 = [1, 2, 3, 4, 5, 6, 7, 8, 9];
console.log(findAverage(number9)); // 5
console.log(findMax(number9)); // 9
