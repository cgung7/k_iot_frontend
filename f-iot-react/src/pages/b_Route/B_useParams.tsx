...
// EX) ~/users   : 모든 사용자 목록
//     ~/users/1 : ID가 1인 사용자 정보 출력
//     ~/users/2 : ID가 2인 사용자 정보 출력
...
//    : useParam를 호출하면 URL에서 변수들을 객체로 반환
//    EX) const params = userParams(); //^ PostDetail 컴포넌트 내에서 호출
