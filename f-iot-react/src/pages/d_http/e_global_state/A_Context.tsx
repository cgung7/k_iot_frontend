...
//? 사용 목적
// : props drilling을 없애고 상태 소스의 단일 책임(Single Source of Trust)을 제공
...
const ExampleHeader = () => {
  ...
  if (!user) {
    return<button onClick={() => setUser({ name: '최광섭'})}>로그인</button>
  }
