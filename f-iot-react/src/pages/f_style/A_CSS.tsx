...
//@ "Global CSS"로써 사용 시
// - CSS파일을 전역으로 import하여, 모든 컴포넌트에 스타일 적용 
...
//@ - reset.css      
//    : 초기화 (UI 프레임워크와 상관없이 필수)
//@ - varoables.css  
//    : CSS 변수 정의 (색상, spacing, typoreaphy 등 디자인 시스템을 변수로 관리) 
//@ - global.css     
//    : 레이아웃 + 공통 요소

//? 4. 일반 CSS 사용 팁
// 1) 초기 세팅: reset.css + variable.css + global.css (3단 구성)
