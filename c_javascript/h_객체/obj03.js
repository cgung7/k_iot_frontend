...
// cf) 객체 리터빌 정의 시: this 값이 정의한 해당 객체에 고정 (myObject로 고정)
...
const person1 = new Person('최광섭'); // this가 person1 (person1.name === 최광섭)
const person2 = new Person('최명섭'); // this가 person2 (person2.name === 최명섭)
