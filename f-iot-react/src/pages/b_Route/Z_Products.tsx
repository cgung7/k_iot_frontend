...
const PRODUCTS = [
  ...
  { id: 2, name: "Headphone", category: "electronics" },
  { id: 3, name: "Desktop", category: "electronics" },
  { id: 4, name: "Shirt", category: "fashion" },
  { id: 5, name: "Pants", category: "fashion" },
  { id: 6, name: "Shoes", category: "fashion" },
];
...
//  const name = searchRarams.get("name");

// +) 쿼리 변경 방법
//    setSearchParmas({ category: '', name: '' });
...
function Z_Products() {
  ...
  const filtered = category
    ? PRODUCTS.filter((produnt) => produnt.category === category)
    : PRODUCTS;
