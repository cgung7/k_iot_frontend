...
//    EX) {"name": "최광섭", "email": "asd@naver.com"}
...
//        EX) /api/v1/users
//        EX) /api/v1/users/1
//        EX) /api/v1/users/1/review
//        EX) /api/v1/users/1/review/10

//        EX) /api/v1/me
//        EX) /api/v1/me/review
//        EX) /api/v1/me/review/10
//@ - 행동) 무엇을 할 것인지
//        GET       : 가져오기 - Body 사용 X
//        POST      : 전송하기 - Body 사용 O
//        PUT       : 수정하기 - Body 사용 O
...
//    : 항상 "전체를 교체한다"라는 규칙
//    - 보내준 코드로 완전히 덮어씌움
// >> PATCH를 모든 API에서 지원하지 않음
//    : 일부 오래된 시스템 또는 프레임워크는 PATCH를 지원하지 X - PUT으로 통일
