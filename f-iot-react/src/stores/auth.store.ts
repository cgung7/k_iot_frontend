...
import { refreshAccessToken, sighOut, signIn } from "@/apis/authApi";
import { create } from "zustand";

//! User 인터페이스 정의
// : 현재 로그인된 사용자 정보를 표현하는 타입
...
interface AuthState {
  ...
  isLoading: boolean;           //@ 로딩 상태 (로그인, 갱신 중인데 여부)
  error: string | null;         //@ 예외 상태 (로그인 오류 메세지 저장용)
