...
`;
console.log(str.trim()); // 시작과 끝ㄴ의 공백만 제거
...
console.log(manyDate);
manyDate = manyDate.trim();

// 줄 바꿈 기호: '\n'
manyDate = manyDate.split('\n');
console.log(manyDate);

manyDate = manyDate.map(line => line.trim().split(','));
console.log(manyDate);
