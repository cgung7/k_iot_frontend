...
//@ 2) 두 번째 인자
// : 의존성 배열
// - 해당 배열 값의 요소가 변결될 때마다 부수 효과가 다시 실행
...
function Effect01() {
  ...
  useEffect(() => {
    ...
    // React Strick Mode는 컴포넌트는 의도적으로 2번 실행
  ...
  return (
    <div>
      ...
      <br />
      <span>{name}</span>
      <button onClick={() => setName(name === '최광섭' ? '이승아' : '최광섭')}>이름 변경</button>
