...
// 2) 차이점
// - let: 동일한 영역 내에서 재선언 불가, 호이스팅 가능(선언부에 올려지고 초기화 되지 않아 "접근 불가")
// - var: 동일한 영역 내에서 재선언 가능, 호아스팅 가능(선언 시 undefined 초기화되어 접근 가능)

//? TDX(Temoral Dead Zone): 변수가 선언되고 초기화 되기까지의 공간
// - let은 TDZ에 있을 경우 사용 불가
// - var는 TDZ의 변수값 사용 가능

// let letVar; - let은 재선언 불가능
...
varVar3 = 40;
console.log(varVar3); // 호스팅과 TDZ 접근 기능으로 내용값 출력 가능
