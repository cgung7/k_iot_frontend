...
function runlater(name = '최광섭') {
  console.log(`Hello, ${name}^^`);
}

runlater(); // Hello, 최광섭^^ - 동기 프로그래밍
...
// 콜백 함수의 인자는 undefined(비워져 있음)이여만 한다.
...
setTimeout(manyParam, 100, '최광섭', 35, 'developer'); // 최광섭 is 35 years old and is developer
