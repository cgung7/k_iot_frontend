...
localStorage.setItem('key', 'value');
localStorage.setItem('username', '최광섭');

// cf) 로컬 스토리지의 데이터는 문자열만 저장 가능
// : 기본 자료형 또한 저장 가능 >> 문자열로 인식
localStorage.setItem('number', 35);
...
console.log(userInfoData); // {"name":"최광섭","age":"35"}
console.log(JSON.parse(userInfoData)); // {name: '최광섭', age: 35}
