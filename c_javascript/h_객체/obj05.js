...
// computer1의 주소값이 복사됨
// : 같은 메모리 주소를 가르킴 (값을 공유)
// >> 얕은 복사
let computer2 = computer1;

computer1.name = 'apple';
console.log(computer2); // { name: 'apple' }
...
// 2) JSON.parse(json)
// : json 문자열을 전달받아 parse(분석하다) JS 객체로 변환
// > 새로운 메모리 위치에 할당
...
console.log(jsonString); // {"title":"백설공주","author":"최광섭","publishYear":2025}

// JS 객체의 키값은 ""따옴표 사용을 생략
// JSON 문자열의 키값은 반드시 "" 사용 필수

let book2 = JSON.parse(jsonString);
console.log(book2); // { title: '백설공주', author: '최광섭', publishYear: 2025 }

book2.title = '신데렐라';
book2.author = '이도경';

console.log(book1); // { title: '백설공주', author: '최광섭', publishYear: 2025 }
