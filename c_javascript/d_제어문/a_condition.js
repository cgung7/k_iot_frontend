...
// - swith 블럭 내에 case 값들이 나열
// +) 어떤 case와도 일치하지 않을 경우 default문 실행

let fruit = 'banana';

// case의 데이터 유형은 swith 식의 데이터 유형과 일치!
switch (fruit) {
  case 'apple':
    console.log('사과');
...
//? if 조건문 VS 삼항 연산자 VS swith문
// 점수를 변수에 담아
//  , 해당 점수가 0미만 100초과일 경우 '유효한 점수가 아닙니다' //! 첫 번째 조건식
...
console.log('=== swith 조건문 ===');

score = 31;

switch (true) {
  case (score < 0 && score > 100):
    console.log('유효한 조건이 아닙니다.');
    break;
  case (score >= 90):
    grade = 'A';
    break;
