...
var currentPage = 1; // 현재 페이지 번호를 추척 (기본값1: 첫 페이지)
var photoPerPage = 4; // 한 페이지 당 표시할 사진 수
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // - 시작인덱스 <= X < 끝인덱스(시작인덱스는 포함하지만 끝 인덱스는 포함하지 않는다)
                    // 1페이지: 0 ~ 3 인덱스
                    // 2페이지: 4 ~ 7 인덱스
                    // ...
...
document.getElementById("prev-button").addEventListener("click", function () {
    // 이벤트 등록될 DOM 요소에 대한 단언: !기호
    if (currentPage > 1) {
        currentPage--;
        updatePhotos();
    }
    else {
        showMessage('첫 번째 페이지입니다.');
    }
});
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (pageNumberElement) {
                        pageNumberElement.textContent = "Page ".concat(currentPage);
                    }
                    return [2 /*return*/];
            }
        });
