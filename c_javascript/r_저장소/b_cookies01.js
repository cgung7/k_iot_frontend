...
// - 만료 날짜(expries): 쿠키의 유효기간(수명, 없으면 세션 종료 시 삭제)
...
// - 쿠키이름, 쿠기값 (필수)
// - 나머지 (선택)
document.cookie = "username=cgs; path=/;"
...
// >> 만료 시간 후에도 메모리상에는 잠시 남이있을 수 있음


//& 3) 쿠키 읽기
// : 쿠키는 하나의 문자열로 반환
console.log(document.cookie);
// username=cgs; userEmail=qwe123; username=cgs; userEmail=qwe123
// >> 문자열이기 때문에 직접 파싱
