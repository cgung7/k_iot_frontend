...
let now = new Date();
console.log(now); // 2025-10-20T03:12:59.987Z (한국 UTC 9시간 빠름: UTC+9)
...
//! 현재 날짜 표기법 & 시간 표기법: Locale(현재의)

console.log(now.toLocaleDateString()); // 2025. 10. 20. // YYYY-MM-DD
console.log(now.toLocaleTimeString()); // 오후 12:21:11 // 오전/오후 HH:mm:SS

// cf) 월-일-연도 (MM-DD-YYYY): 미국, 캐나다 등

//! == 요일 테이터 문자열 반환 == //
const current = new Date();
console.log(current); // 2025-10-20T03:23:29.684Z
