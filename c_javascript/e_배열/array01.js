...
// 2)lastIndexOf(요소값): 배열의 끝부터찾는 요소의 첫 번째 인덱스를 반환 (없으면 -1)
console.log(snacks.lastIndexOf('초코송이')); // 3
console.log(snacks.lastIndexOf('딸기송이')); // -1

// 3) includes(): 배열의 해당 요소의 존재 여부를 확인 - boolean 값 반환
...
//          unshift() - 제일 첫 번째 요소 부터 하나 이상의 요소를 추가 (+ 수정된 배열 길이를 반환)
// 2) 삭제: pop()     - 맨 마지막에 요소 제거 (+ 해당 값 반환)
...
console.log(fruitValues.join()); // 사과,바나나,망고 // 구분자를 전덜하지 않으면 기본값 ','
